# ============================================================================
#  USG Model 496 Sizing Tool  |  sizing algorithm (SOURCE OF TRUTH)
#
#  This is "496 Script.py" with the interactive CLI input() prompts and the
...
#  oversizeby, oversize_percent, gastypemult, pload, Patm, result496).
#
#  THIS FILE IS THE SOURCE OF TRUTH. Editing it and pushing is all that is
#  required: CI transpiles it to dist/usg-model-496.js, proves the JavaScript
