...
module.exports = {
  fill(d, input) {
    ...
    // The 143 only offers an internal relief valve, so "Yes" goes straight to
  ...
  formChecks(d, check) {
    ...
    check('no min-flow field (not on the 143)', doc.getElementById('usg-minflow') === null);
    ...
    check('pipe options are the 143 set',
